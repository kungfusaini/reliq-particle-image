...
A significant enhancement to the original [particle-image](https://github.com/paxtonfitzpatrick/particle-image) library with over 4x the functionality and a modern, modular architecture.
